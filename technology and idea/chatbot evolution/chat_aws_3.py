...
acquire: faiss with cosine similarity | rerank with open and rag model to obtain the best result
...
manually delete some critical persona inconsistent issue
provide summary model to record user's persona
"""
