...
#     return response['text'], response['top_docs']
#
#
# """
# Rule Based Model
...
#                 result_final, _ = find_rag_open(context[-1:])
#         else:
...
#                     result_final, top_doc = find_rag_open(context[-1:])
#                     context[-2] = context[-2] + " " + top_doc[0]
#                     result_final = find_response_open(["HI", top_doc[0]], [], blender_memory_agent)
#                 else:
